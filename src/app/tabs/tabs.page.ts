...
export class TabsPage {
  ...
  private async startNativeTabs(): Promise<void> {
    ...
    this.listener = await NativeNavigation.addListener('tabSelect', ({ id }) => {
      void this.router.navigate(['/tabs', id]);
    });
  }
}
